...
export function makeServer({ environment = "development" } = {}) {
  return new Server({
    ...
    routes() {
      ...
      this.get("/user/:userName", getUserByUserNameHandler.bind(this));
      ...
      //external api
      this.passthrough();
      this.passthrough("https://api.cloudinary.com/v1_1/dxe21vniv/image/upload");
      this.passthrough("https://api.cloudinary.com/v1_1/dxe21vniv/delete_by_token");
    },
  });
}
